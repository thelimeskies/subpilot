...
from .portal_views import (
    ...
    PortalPaymentMethodCheckoutConfirmView,
...
urlpatterns = [
    ...
    path(
        "payment-methods/checkout/confirm",
        PortalPaymentMethodCheckoutConfirmView.as_view(),
        name="portal-payment-method-checkout-confirm",
    ),
    path(
